...
export default function App() {
  ...
  return (
    <ImageBackground source={blurBg} className="bg-gray-900 px-8 py-10 items-center flex-1 relative" imageStyle={{position: 'absolute', left: '-100%'}}>
     ...
     <View className="flex-1 items-center justify-center gap-6">
      ...
      <TouchableOpacity activeOpacity={0.5} className="rounded-full bg-green-500 px-5 py-2">
        <Text className="font-alt text-sm uppercase text-black">COMEÇAR A CADASTRAR</Text>
      </TouchableOpacity>
     </View>

     <Text className="text-center font-body text-sm leading-relaxed text-gray-200">
      Feito com 💜 por Antonio Carlos 
     </Text>
